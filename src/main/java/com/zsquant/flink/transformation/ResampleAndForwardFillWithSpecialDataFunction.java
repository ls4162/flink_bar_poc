...
public class ResampleAndForwardFillWithSpecialDataFunction extends ProcessWindowFunction<TheoPriceCalcEntity, TheoPriceCalcEntity, String, TimeWindow> {
    ...
    public void process(String key, Context context, Iterable<TheoPriceCalcEntity> elements, Collector<TheoPriceCalcEntity> out) throws Exception {
        ...
        for (TheoPriceCalcEntity element : elements) {
            if (element.getMockData() == Boolean.TRUE) {
                continue;
            }
